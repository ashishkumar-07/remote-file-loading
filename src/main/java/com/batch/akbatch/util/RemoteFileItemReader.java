 ...
 */
public class RemoteFileItemReader<T> extends AbstractItemCountingItemStreamItemReader<T> implements
		ResourceAwareItemReaderItemStream<T>, InitializingBean {

	private static final Log logger = LogFactory.getLog(RemoteFileItemReader.class);
	...
	public RemoteFileItemReader() {
		setName(ClassUtils.getShortName(RemoteFileItemReader.class));
	}
